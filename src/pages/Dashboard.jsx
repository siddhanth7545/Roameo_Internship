...
export default function Dashboard() {
    ...
    <div className="flex flex-col h-screen  p-3 bg-gray-100 shadow w-200">
            ...
            <div class="hidden xl:flex justify-start p-6 items-center space-x-3">
                ...
                <p class="text-2xl leading-6 text-black-100">Hello Rider</p>
            </div>
            <div class="mt-6 flex flex-col justify-start items-center  pl-4 w-full border-gray-600 border-b space-y-3 pb-5 ">
                <button class="flex jusitfy-start items-center space-x-6 w-full  focus:outline-none  focus:text-orange-100  text-black-100 rounded ">
                    ...
                    <p class="text-base leading-4 text-black-100  focus:text-orange-100 text-left">Dashboard</p>
                </button>
                
                <button  onClick={() => {
                  navigate('/myprofile1')
                }} class="flex jusitfy-start items-center w-full  space-x-6 focus:outline-none text-black-100 focus:text-orange-100  active:bg-orange-100 rounded ">
                    <svg class="fill-stroke" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <p class="text-base leading-4  text-black-100 ">Profiile</p>
                </button>
            </div>
            <div class="flex flex-col justify-start items-center   px-6 border-b border-gray-800 w-full  ">
                <button onclick="showMenu1(true)" class="focus:outline-none focus:text-orange-100 text-left   text-black-100 flex justify-between items-center w-full py-5 space-x-14 active:bg-orange-100  ">
                    <p class="text-sm leading-5  uppercase">Rides</p>
                ...
                <button  onClick={() => {
                  ...
                  navigate('/createride')
                    ...
                    <button class="flex justify-start items-center space-x-6 hover:text-white focus:bg-orange-100 focus:text-white hover:bg-orange-100 text-gray-900 rounded px-3 py-2  w-full md:w-52">
                        ...
                        <p class="text-base leading-4  ">Help</p>
                    </button>
                        
                </div>
            </div>
            <div class="flex flex-col justify-start items-center   px-6 border-b border-gray-600 w-full  ">
                <button onclick="showMenu2(true)" class="focus:outline-none focus:text-orange-100  text-black-100 flex justify-between items-center w-full py-5 space-x-14  ">
                    <p class="text-sm leading-5 uppercase">Your Rides</p>
            ...
            <button onclick="showMenu3(true)" class="focus:outline-none focus:text-orange-100  text-black-100 flex justify-between items-center w-full py-5 space-x-14  ">
                    <p class="text-sm leading-5  uppercase">Top Riders</p>
                ...
                <div class=" flex justify-between items-center w-full">
                    <div class="flex justify-center items-center  space-x-2">
                        ...
                        <div class="flex justify-start flex-col items-start">
                            <p class="cursor-pointer text-sm leading-5 text-black-100">Shweta Khedkar</p>
                            <p class="cursor-pointer text-xs leading-3 text-gray-600">
                                <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="13727f766b7a602b2253747e727a7f3d707c7e">[email &#160;protected]</a>
                            </p>
                        </div>
                    </div>
